		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsaplhmrzcustomerpreference-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzcustomerpreference-display": {
								"semanticObject": "comsaplhmrzcustomerpreference",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zcustomerpreference",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zcustomerpreference")
								}
							}
						}
					}
